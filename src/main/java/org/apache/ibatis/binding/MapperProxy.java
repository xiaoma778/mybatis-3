...
public class MapperProxy<T> implements InvocationHandler, Serializable {
    ...
    /** 用于缓存 MapperMethod 对象，其中 key 是 Mapper 接口中方法对应的 Method 对象，value 是对应的 MapperMethodInvoker
     *  对象。MapperMethodInvoker 对象会完成参数转换以及 SQL 语句的执行功能。需要注意的是，MapperMethodInvoker 中并不记录任何状态
     *  相关的信息，所以可以在多个代理对象之间共享
     * */
