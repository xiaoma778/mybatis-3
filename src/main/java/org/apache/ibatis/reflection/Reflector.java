 ...
 *
 * Reflector 是 Mybatis 中反射模块的基础，每个 Reflector 对象都对应一个类，
 * 在 Reflector 中缓存了反射操作需要使用的类的元信息
 *
...
public class Reflector {
    ...
    //属性相应的 getter 方法，key 是属性名称，value 是 Invoker 对象
    ...
    /**
     * 处理类中定义的所有字段，并将处理后的字段信息添加到 setMethods集合、setTypes集合、getMethods集合以及 getTypes集合中
     * @param clazz
     */
