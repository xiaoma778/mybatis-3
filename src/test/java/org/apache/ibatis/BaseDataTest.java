...
public abstract class BaseDataTest {
    ...
    public static final String BLOG_PROPERTIES = "org/apache/ibatis/databases/blog/blog-derby.properties";//derby数据库连接配置信息
    public static final String BLOG_DDL = "org/apache/ibatis/databases/blog/blog-derby-schema.sql";//建表语句
    public static final String BLOG_DATA = "org/apache/ibatis/databases/blog/blog-derby-dataload.sql";//数据初始化语句
    ...
    /**
     * 使用 derby （一款完全用java编写的数据库），初始化 blog 相关表结构及其数据
     * @return DataSource
     * @throws IOException
     * @throws SQLException
     */
